...
| `headers` | object | `{}` | Custom HTTP headers applied to every page the crawl fetches over HTTP. A `User-Agent` here overrides the default. Browser renders do not apply them yet |
